...
expectSeries(/无职转生/, series => series.members.some(member => /第二季/.test(member.title)) && series.members.some(member => /第三季/.test(member.title) && member.status === 'RELEASING'), '无职转生必须分列第二季和连载中的第三季')
